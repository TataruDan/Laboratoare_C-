...
int main() {
    ...
    int h,min;
        ...
        scanf("%s", dest);
            ...
            countingSort_nr_tren(tren,n);
            afisare_dest(tren,n,dest);

            printf("Sortarea dupa ora sosirii : \n\n");
            countingSort_ora_sosire(tren,n);
            afisare_dest(tren,n,dest);

            printf("\n\n");

            printf("Heap Sort\n\n\n");
            heapSort_nr_tren(tren,n);
            printf("Sortarea dupa numarul de tren : \n\n");
            afisare_dest(tren,n,dest);

            heapSort_ora_sosire(tren,n);
            printf("Sortarea dupa ora sosirii : \n\n");
            afisare_dest(tren,n,dest);
