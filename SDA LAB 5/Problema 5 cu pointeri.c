...
int main() {
    ...
    if(checker != 1) {
        ...
        Ins_sort_prog(p_student,n,spec);
        Ins_sort_filoz(p_student,n,spec);
        Ins_sort_eng(p_student,n,spec);

        printf("\n\n------------------------------------------------------------------------------\n");

        quickSort_prog(p_student, 0, n - 1,spec);
        ...
        for(int i = 0; i < n; i++)
        {
            ...
            if(strcmp(spec,p_student[i].specialitate) == 0) {
                printf("%s\t\t%d\n" ,p_student[i].prenume,p_student[i].prog);
            }
        }

        quickSort_filoz(p_student,0,n-1,spec);
        ...
        for(int i = 0; i < n; i++)
        {
            ...
            if(strcmp(spec,p_student[i].specialitate) == 0) {
                printf("%s\t\t%d\n" ,p_student[i].prenume,p_student[i].filoz);
            }
        }

        quickSort_eng(p_student,0,n-1,spec);
        ...
        for(int i = 0; i < n; i++)
        {
            ...
            if(strcmp(spec,p_student[i].specialitate) == 0) {
                printf("%s\t\t%d\n" ,p_student[i].prenume,p_student[i].eng);
            }
        }
